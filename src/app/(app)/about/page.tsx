          ...
          {[
            {
              ...
              detail: '「設計レイヤー」タブで、コアバリュー・ロードマップ・仕様デザインの各層にドキュメントを作成し、cover_until（どこまで設計できているか）を設定します。これがダッシュボードの「設計貯金残高」に反映されます。',
            },
            {
              step: 'Step 2',
              title: 'タスクを作成し、今週のフォーカスを設定する',
              detail: '「タスク」タブからタスクを作成します。各タスクの★アイコンでフォーカスON/OFFを切り替え。ダッシュボードに「今週やること」として最大3件表示されます。',
            },
            {
              step: 'Step 3',
              title: 'AIに着手サポートを依頼する',
              detail: 'タスク詳細画面で「次の一手を提案してもらう」か「リサーチを手伝ってもらう」をクリック。AIが具体的なアクションを提案します。ダッシュボードでも最も止まっているタスクに対して自動でサジェストされます。',
            },
            {
              step: 'Step 4',
              title: '貯金残高を定期的に補充する',
